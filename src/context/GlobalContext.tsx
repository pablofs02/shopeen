 ...
 */
export function loadRecommendations(productsArray: Product[]) {
    let items = productsArray;
    let res = [];
    let elem = items[0];
    for (let i = 0; i < 3; i++) {
        do {
 ...
 */
export function loadBestsellers(productsArray: Product[]) {
    let items = productsArray;
    let res = [];
    let elem = items[0];
    for (let i = 0; i < 3; i++) {
 ...
 */
export function loadOnStock(productsArray: Product[]) {
    let items = productsArray;
    let res = [];
    let elem = items[0];
    for (let i = 0; i < 3; i++) {
