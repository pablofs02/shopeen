  ...
  return (
    <section tabIndex={0} className="cuerpo about">
      ...
      <section>
        ...
        <h3 className="">
          This app has been created as a project for the class "Interfaces de
          Usuario" at Universidad de Málaga.
        </h3>
      </section>
      <section className="team-section mt-4">
        ...
        <ul>
          <li>
            <span>
              <strong>Pablo Fernández Serrano</strong>
            </span>
          </li>
          <li>
            <span>
              <strong>Guillermo Tell González</strong>
            </span>
          </li>
          <li>
            <span>
              <strong>Javier Lanceta Salas (Team Leader)</strong>
            </span>
          </li>
          <li>
            <span>
              <strong>Javier Leiva Dueñas</strong>
            </span>
          </li>
        </ul>
      </section>
